...
| `luksEncryption` | Activez le chiffrement LUKS. Reportez-vous à link:../trident-reco/security-luks.html["Utiliser la configuration de clé unifiée Linux (LUKS)"]. SAN uniquement. | « » 
