...
ASTRA Trident peut créer des volumes Cloud Volumes Service dans l'une des deux link:https://cloud.google.com/architecture/partners/netapp-cloud-volumes/service-types["types de service"^]:
