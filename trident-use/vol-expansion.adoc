...
ASTRA Trident prend en charge l'extension de volume pour les volumes NFS PVS provisionnés sur `ontap-nas`, `ontap-nas-economy`, `ontap-nas-flexgroup` `gcp-cvs` et les `azure-netapp-files` systèmes back-end.
