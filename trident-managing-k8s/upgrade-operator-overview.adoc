...
TIP: Pour plus d'informations sur l'architecture Astra Trident sur le cluster Kubernetes, veuillez vous référer à link:../trident-get-started/architecture.html["Architecture Trident"].
