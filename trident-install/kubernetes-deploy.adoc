...
[%collapsible%open]
====
* Kubernetes 1.30 est désormais pris en charge dans Astra Trident. Mettez à niveau Trident avant de mettre à niveau Kubernetes.
...
Choisissez la méthode d'installation qui vous convient. Vous devriez également examiner les considérations pour link:kubernetes-deploy.html#moving-between-installation-methods["passage d'une méthode à l'autre"] avant de prendre votre décision.
